...
- `FOURSQUARE_API_KEY`: Foursquare Places search and live place details.
...
- Roamboard persists the Foursquare place ID plus user-authored category, note, source link, ordering, and collaborator metadata.
...
- The PWA service worker excludes `/api`, Mapbox, and Foursquare requests. It caches only the app shell and same-origin static assets.
